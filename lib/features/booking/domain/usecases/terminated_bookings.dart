...
class TerminatedBookings implements UseCase<List<Booking>, AllBookingParams> {
  final BookingRepository bookingRepository;
  TerminatedBookings({required this.bookingRepository});
  @override
  Future<Either<Failure, List<Booking>>> call(AllBookingParams params) async {
    return await bookingRepository.all(params.copyWith(status: 'Terminated'));
  }
}
