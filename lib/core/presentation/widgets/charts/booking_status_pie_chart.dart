import 'package:adminetic_booking/core/presentation/widgets/charts/indicator.dart';
...
class BookingStatusPieChart extends StatefulWidget {
  const BookingStatusPieChart({super.key});

  @override
  State<StatefulWidget> createState() => BookingStatusPieChartState();
}

class BookingStatusPieChartState extends State {
  int touchedIndex = -1;
